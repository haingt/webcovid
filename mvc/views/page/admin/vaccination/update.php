...
?>
            <div class="mt-5 ml-5">
                ...
                <form action="./admin/upm1/<?php echo $item->injection_id ?>" method="POST">
                    ...
                    <input type="date" class="form-control" id="pwd" placeholder="" name="regiter_date" value="<?php echo $item->register_date?>">
                    </div>
