...
if(isset($data["list1"])) $list = json_decode($data["list1"]);
else {
...
?>
            <div class="mt-5 ml-5">
                <h3>Danh sách mũi tiêm 1: <?php if(is_array($list)) echo count($list)." tài khoản" ?></h3>
                        ...
                        $i=1;
                            foreach ($list as $item) {
                                ...
                                echo ' <tr class="bg-light">
                                            ...
                                            <td class="text-center" ><a class="px-3" href="./admin/UpdateM1/'.$item->injection_id.'">Chỉnh sửa</a><a class="px-3" href="./admin/DeleteM1/'.$item->injection_id.'">Xoá</a></td>
                                        </tr>'
                                ;
                                }
